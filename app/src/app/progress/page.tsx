    ...
    <main className="flex-1 flex flex-col relative min-h-screen overflow-hidden">
      ...
      <header className="w-full p-6 flex justify-between items-center z-10 border-b border-white/5 bg-[#0f1117]/80 backdrop-blur-md">
        ...
        <nav className="flex items-center gap-6 text-sm font-medium text-gray-300">
          ...
          <Link href="/progress" className="text-white hover:text-white transition-colors">Progress</Link>
      ...
      <div className="flex-1 max-w-5xl w-full mx-auto p-6 md:p-12 z-10">
        ...
        >
          <div>
            ...
            <p className="text-gray-400">Track your stress management over time.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass-card rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-sm text-gray-400">Total sessions completed</p>
            </div>
            ...
            <div className="glass-card rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-sm text-gray-400">Based on last 3 sessions</p>
            </div>
          </div>

          {/* Placeholder for chart */}
          <div className="glass-card rounded-2xl p-8 border border-white/10 h-80 flex items-center justify-center mt-6">
            <p className="text-gray-500 font-medium">Stress Trend Chart (Coming Soon in V2)</p>
          </div>
